...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference("Department.count") do
      post departments_url, params: { department: { chief_name: @department.chief_name, factory_id: @department.factory_id } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { chief_name: @department.chief_name, factory_id: @department.factory_id } }
